...
import mailTransportLoader from '../../src/loaders/mailer';

import setupTestDB from '../utils/setupTestDB';
import getApp from '../utils/getApp';
import { userOne, admin, insertUsers } from '../fixtures/userFixture';
import { userOneAccessToken, adminAccessToken } from '../fixtures/tokenFixture';
...
describe('Auth routes', () => {
  ...
  describe('POST /v1/auth/forgot-password', () => {
    beforeEach(async () => {
      jest.spyOn(await mailTransportLoader(), 'sendMail').mockResolvedValue();
    });
...
describe('Auth middleware', () => {
  test('should call next with no errors if access token is valid', async () => {
    ...
    expect(req.userData._id).toEqual(userOne._id);
  });
